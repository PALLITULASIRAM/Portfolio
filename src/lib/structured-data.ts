...
export function generateWebsiteStructuredData() {
  return {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "PALLI TULASIRAM - Portfolio",
    url: "https://pallitulasiram.vercel.app",
    description:
      "PALLI TULASIRAM's portfolio featuring projects in React, Next.js, and modern web development",
    author: {
      "@type": "Person",
      name: selfData.name,
    },
...
export function generateOrganizationStructuredData() {
  return {
    ...
    name: selfData.name,
    url: "https://pallitulasiram.vercel.app",
    logo: "https://pallitulasiram.vercel.app/images/logo.png",
    description: selfData.bio,
    founder: {
      "@type": "Person",
      name: selfData.name,
...
export function generateResumeStructuredData() {
  return {
    ...
    name: "PALLI TULASIRAM Resume",
    description:
      "Professional resume of PALLI TULASIRAM - Student Developer specializing in Full-Stack Web Development",
